        ...
        .forEach(function(form) {
            form.addEventListener('submit', function(event) {
                if (!form.checkValidity()) {
                    ...
                    bootoast.toast({
                        message: "<i class='fa-solid fa-circle-exclamation'></i> Please fill the form properly",
                        type: 'warning',
                        position: 'rightTop'
                        });
                }
