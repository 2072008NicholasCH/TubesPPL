                    ...
                    <table id="example2" class="table table-bordered table-striped dataTable" style="width:100%">
                        ...
                        <tbody>
                            ...
                            foreach ($jadwal->array_berita_acara as $index => $item) {
                                ...
                                echo "<td>" . date('h:i a', strtotime($item->getWaktuMulai())) . "</td>";
                                echo "<td>" . date('h:i a', strtotime($item->getWaktuSelesai())) . "</td>";
                                ...
                                echo "<td><button class='btn btn-warning' data-dismiss='modal' data-toggle='modal' data-target='#beritaAcara-" . $item->getIdBeritaAcara() . "'><i class='fa-solid fa-pen-to-square'></i></button></td>";
